...
class Spiel():
    ...
    def __str__(self):
        ...
        congrats_line = f"Guter Beitrag für das Team, Isi!\n" if isi_wins > isi_plays/2 else f"Schade, Isi. Nächstes Mal besser!\n"
...
class Game():
    ...
    def __str__(self):
        opening_line = "Wuhu Isi hat dieses Spiel gewonnen\n" if self.did_isi_win() else "Schade, Isi hat dieses Spiel verloren. Da muss sie wohl noch gegen Philipp üben.\n"
